...
int analyze_stress_tensor(std::string pressure_to_calc, int v_comp, double *stress);
int analyze_stress_pair(std::string pressure_to_calc, int type1, int type2, int v_comp, double *stress);
int analyze_stress_single(std::string pressure_to_calc, int bond_or_type, int v_comp, double *stress);
